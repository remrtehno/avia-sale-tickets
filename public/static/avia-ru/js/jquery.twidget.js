  ...
  var pluginName = 'twidget',
    defaults = {
      ...
      localization: {
        ...
        avia_logo_content:
          '<div class="twidget-logo-image twidget-jetradar-logo-img" width="30" height="30"></div>jetradar',
  ...
  function Plugin(element, options) {
    ...
    if (this.settings.locale == 'ru') {
      this.settings.localization = {
        ...
        avia_logo_link: '/flights',
        avia_logo_content: '',
        // hotel_logo_link: 'https://hotellook.ru/',
        avia_submit_domain: '/flights',
      }
    }
  ...
  $.extend(Plugin.prototype, {
    init: function () {
      ...
      var origin_iata_input = container.find('input[name="origin_iata"]'),
        destination_iata_input = container.find(
          'input[name="destination_iata"]'
        ),
        ...
        adults_pas_input = container.find(
          '#twidget-passenger-form input[name="adults"]'
        ),
        children_pas_input = container.find(
          '#twidget-passenger-form input[name="children"]'
        ),
      ...
      container.find('.twidget-tab-links a').on('click', function (e) {
        var currentAttrValue = $(this).attr('href'),
          currentTabContentHeight =
            container.find('.twidget-tab-content').height() + 20

        // Show/Hide Tabs
        container
          .find('.twidget-tab-content')
          .css({ height: currentTabContentHeight })
        container
          .find('.twidget-tabs ' + currentAttrValue)
          .siblings()
          .fadeOut(200)
        setTimeout(function () {
          container.find('.twidget-tabs ' + currentAttrValue).fadeIn(200)
          container.find('.twidget-tab-content').css({ height: 'auto' })
        }, 250)
      ...
      $(document).on(
        ...
        function () {
          ...
          if (button.text() == '+') {
            if (
              (button.attr('data-age') == 'adults' ||
                button.attr('data-age') == 'children') &&
            ...
            if (
              button.attr('data-age') == 'infants' &&
              newVal < adults_pas_count &&
              adults_pas_count + children_pas_count + infants_pas_count < 9
            ) {
            ...
            if (button.attr('data-age') == 'children-g' && newVal < 3) {
              ...
              newVal++
              container
                .find('#twidget-guest-form .twidget-pas-class ul')
                .append(
                  // add +1 child guest age selection
                  '<li>' +
                    '<div class="twidget-cell twidget-age-name">' +
                    _this.settings.localization
                      .hotel_guests_select_children_age +
                    '</div>' +
                    '<div class="twidget-cell twidget-age-select">' +
                    '<span class="twidget-dec twidget-q-btn" data-age="one-child">-</span><span class="twidget-num"><input type="text" name="children[' +
                    newVal +
                    ']" value="8"></span><span class="twidget-inc twidget-q-btn" data-age="one-child">+</span>' +
                    '</div>' +
                    '</li>'
                )
            ...
            if (input.val() > 0) {
              ...
              if (button.attr('data-age') == 'children-g') {
                ...
                container
                  .find('#twidget-guest-form .twidget-pas-class li:last-child')
                  .remove()
                if (newVal == 0) {
                  container
                    .find('#twidget-guest-form .twidget-pas-class')
                    .hide()
                }
              }
            } else {
          ...
          container
            .find(
              '#twidget-passenger-form input[name="adults"], #twidget-passenger-form input[name="children"], input[name="infants"]'
            )
            .trigger('change')
          guests_count_label.html(0)
          container
            .find(
              '#twidget-guest-form input[name="adults"], #twidget-guest-form input[name="children_sum"]'
            )
            .trigger('change')
        }
      )
      ...
      container
        ...
        .on('change', function () {
          ...
          if (current_count + input_count >= 5) {
            container
              .find('.twidget-pas-caption')
              .text(_this.settings.localization.avia_passengers_caption_5)
          } else if (current_count + input_count != 1) {
            container
              .find('.twidget-pas-caption')
              .text(_this.settings.localization.avia_passengers_caption_2)
          } else {
            container
              .find('.twidget-pas-caption')
              .text(_this.settings.localization.avia_passengers_caption_1)
          }
        })
      ...
      container
        ...
        .on('change', function () {
          ...
          if (current_count + input_count >= 5) {
            container
              .find('.twidget-guest-caption')
              .text(_this.settings.localization.hotel_guests_caption_5)
          } else if (current_count + input_count != 1) {
            container
              .find('.twidget-guest-caption')
              .text(_this.settings.localization.hotel_guests_caption_2)
          } else {
            container
              .find('.twidget-guest-caption')
              .text(_this.settings.localization.hotel_guests_caption_1)
          }
        })
      ...
      container.find('.twidget-pass-class').change(function () {
        if (this.checked) {
          container
            ...
            .html(_this.settings.localization.avia_passengers_business_class)
          ...
          container
            ...
            .html(_this.settings.localization.avia_passengers_economy_class)
      ...
      var dateSelect = container.find('#twidget-flight-datepicker'),
        ...
        iconReturnCal = container.find(
          '.twidget-return-date .twidget-icon-cal'
        ),
        iconReturnDel = container.find(
          '.twidget-return-date .twidget-icon-delete'
        ),
      ...
      dateSelect
        ...
        .on('change', function () {
          if (dateDepart.val()) {
            var start =
              dateDepart.datepicker('getDate').getDate() +
              ' ' +
              _this.settings.localization.month_names[
                dateDepart.datepicker('getDate').getMonth()
              ] +
              ', ' +
              _this.settings.localization.weekdays_short[
                dateDepart.datepicker('getDate').getDay()
              ]
            spanDepart.text(start.toLowerCase())
          }
          if (dateReturn.val()) {
            var end =
              dateReturn.datepicker('getDate').getDate() +
              ' ' +
              _this.settings.localization.month_names[
                dateReturn.datepicker('getDate').getMonth()
              ] +
              ', ' +
              _this.settings.localization.weekdays_short[
                dateReturn.datepicker('getDate').getDay()
              ]
          ...
          $(document)
            .find('.datepicker tbody')
            .removeClass('with-return-button')
        })
        .on('click', function () {
      ...
      dateReturn.focus(function () {
        setTimeout(function () {
          if (
            !$(document)
              .find('.datepicker tbody')
              .hasClass('with-return-button')
          ) {
            $(document)
              .find('.datepicker tbody .datepicker-cancel-return-date')
              .parent()
              .remove()
            $(document)
              .find('.datepicker tbody')
              .append(
                '<tr><td class="datepicker-cancel-return-date">' +
                  _this.settings.localization.datepicker_return_ticket_caption +
                  '</td></tr>'
              )
            $(document).find('.datepicker tbody').addClass('with-return-button')
            $(document)
              .find('.datepicker-cancel-return-date')
              .click(function () {
                iconReturnDel.click()
              })
      ...
      dateSelect1
        ...
        .on('change', function () {
          if (dateDepart1.val() && dateReturn1.val()) {
            var start =
              dateDepart1.datepicker('getDate').getDate() +
              ' ' +
              _this.settings.localization.month_names[
                dateDepart1.datepicker('getDate').getMonth()
              ] +
              ', ' +
              _this.settings.localization.weekdays_short[
                dateDepart1.datepicker('getDate').getDay()
              ]
            var end =
              dateReturn1.datepicker('getDate').getDate() +
              ' ' +
              _this.settings.localization.month_names[
                dateReturn1.datepicker('getDate').getMonth()
              ] +
              ', ' +
              _this.settings.localization.weekdays_short[
                dateReturn1.datepicker('getDate').getDay()
              ]
      ...
      if (_this.settings.default_origin) {
        $.getJSON(
          'https://autocomplete.travelpayouts.com/jravia?locale=' +
            _this.settings.locale +
            '&with_countries=false&q=' +
            _this.settings.default_origin,
          function (data) {
            ...
            if (data) {
              container
                ...
                .on('focusout', function () {
                  ...
                  container
                    .find('.twidget-origin .twidget-pseudo-name')
                    .text(data[0].city_name)
                  container
                    .find('.twidget-origin .twidget-pseudo-country-name')
        ...
        $.getJSON(
          'https://www.travelpayouts.com/whereami?locale=' +
            _this.settings.locale,
          function (data) {
            /* input focusout update */
            if (data) {
      ...
      container.find('#twidget-origin').keyup(function () {
        ...
        $.getJSON(
          ...
          function (data) {
            container
              .find('.twidget-origin .twidget-auto-fill-wrapper ul li')
              .remove()
            ...
            $.each(citiesOrigSort, function (key, value) {
              if (citiesSortedArr[value].main) {
                container
                  .find('.twidget-origin .twidget-auto-fill-wrapper ul')
                  .append(
                    '<li class="clearfix">' +
                      '<span class="twidget-city-name" data-name="' +
                      citiesSortedArr[value].main.city_name +
                      '" data-country="' +
                      citiesSortedArr[value].main.country_name +
                      '">' +
                      citiesSortedArr[value].main.city_name +
                      ', <span>' +
                      citiesSortedArr[value].main.country_name +
                      '</span></span>' +
                      '<span class="twidget-num-hotel">' +
                      citiesSortedArr[value].main.code +
                      '</span><br>' +
                      '<span class="twidget-city-airport-name">' +
                      _this.settings.localization.avia_all_airports_caption +
                      '</span></li>'
                  )
              }
              $.each(citiesSortedArr[value], function (childKey, childValue) {
                container
                  ...
                  .append(
                    '<li class="clearfix" ' +
                      (citiesSortedArr[value].main && childKey != 'main'
                        ? 'style="padding-left:30px;"'
                        : '') +
                      '>' +
                      '<span class="twidget-city-name" data-name="' +
                      childValue.city_name +
                      '" data-country="' +
                      childValue.country_name +
                      '">' +
                      childValue.city_name +
                      (citiesSortedArr[value].main && childKey != 'main'
                        ? ''
                        : ', <span>' + childValue.country_name + '</span>') +
                      '</span>' +
                      '<span class="twidget-num-hotel">' +
                      childValue.code +
                      '</span><br>' +
                ...
                .on('focusout', function () {
                  focus_timeout = setTimeout(function () {
                    ...
                    container
                      ...
                      .remove()
                    container
                      .find('.twidget-origin .twidget-auto-fill-wrapper')
                      .removeClass('active')
                  }, 200)
                })
            }
      ...
      if (_this.settings.default_destination) {
        $.getJSON(
          'https://autocomplete.travelpayouts.com/jravia?locale=' +
            _this.settings.locale +
            '&with_countries=false&q=' +
            _this.settings.default_destination,
          function (data) {
            /* input focusout update start */
            if (data) {
              container
                ...
                .on('focusout', function () {
                  ...
                  container
                    .find('.twidget-destination .twidget-pseudo-name')
                    .text(data[0].city_name)
                  container
                    .find('.twidget-destination .twidget-pseudo-country-name')
                    .text(', ' + data[0].country_name)
      ...
      if (_this.settings.lock_destination == false) {
        ...
        container.find('#twidget-destination').keyup(function () {
          ...
          $.getJSON(
            ...
            function (data) {
              container
                .find('.twidget-destination .twidget-auto-fill-wrapper ul li')
                .remove()
              $.each(data, function (key, value) {
                if (value.city_name) {
                  if (!citiesSortedArr[value.city_code]) {
              ...
              $.each(citiesOrigSort, function (key, value) {
                if (citiesSortedArr[value].main) {
                  container
                    .find('.twidget-destination .twidget-auto-fill-wrapper ul')
                    .append(
                      '<li class="clearfix">' +
                        '<span class="twidget-city-name" data-name="' +
                        citiesSortedArr[value].main.city_name +
                ...
                container
                  ...
                  .on('focusout', function () {
                    focus_timeout = setTimeout(function () {
                      ...
                      container
                        .find(
                          '.twidget-destination .twidget-auto-fill-wrapper ul li'
                        )
                        .remove()
                      container
                        .find('.twidget-destination .twidget-auto-fill-wrapper')
                        .removeClass('active')
                    }, 200)
                  })
              }
      ...
      if (_this.settings.default_destination) {
        $.getJSON(
          'https://engine.hotellook.com/api/v2/lookup.json?query=' +
            _this.settings.default_hotel_location +
            '&lang=' +
            _this.settings.locale +
            '&limit=4',
          function (data) {
            ...
            if (focus_destination) {
              container
                ...
                .on('focusout', function () {
                  ...
                  container
                    .find('.twidget-city-hotel .twidget-pseudo-name')
                    .text(focus_destination)
                  container
                    .find('.twidget-city-hotel .twidget-pseudo-country-name')
                    .text(', ' + focus_country)
                  container
                    .find(
                    ...
                    .remove()
                  container
                    .find('.twidget-city-hotel .twidget-auto-fill-wrapper')
                    .removeClass('active')
                })
      ...
      container.find('#twidget-city-hotel').keyup(function () {
        ...
        $.getJSON(
          ...
          function (data) {
            container
              .find('.twidget-city-hotel .twidget-auto-fill-wrapper ul li')
              .remove()
            /* append cities */
            $.each(data.results.locations, function (key, value) {
              container
                .find('.twidget-city-hotel .twidget-auto-fill-wrapper ul')
                .append(
                  '<li class="clearfix ' +
                    (key == 0 ? 'main-city' : '') +
                    '">' +
                    '<span class="twidget-city-name" data-destination="' +
                    value.cityName +
                    '" data-country="' +
                    value.countryName +
                    '">' +
                    ...
                    value.hotelsCount +
                    ' ' +
                    (value.hotelsCount > 5 || value.hotelsCount < 1
                      ? _this.settings.localization.hotels_count_caption_5
                      : value.hotelsCount == 1
                      ? _this.settings.localization.hotels_count_caption_1
                      : _this.settings.localization.hotels_count_caption_2) +
                    '</span></li>'
                )
            })
            /* append hotels */
      ...
      $('#twidget-origin, #twidget-destination, #twidget-city-hotel').click(
        function () {
          $(this).select()
        }
      )
    ...
    widget_html: function () {
      ...
      $(this.element).html(
        '<!-- start widget-->' +
          ...
          '            <ul class="clearfix">' +
          '                <li id="twidget-flight-li" class="active"><a href="#twidget-tab1">' +
          _this.settings.localization.avia_tab_caption +
          '</a></li>' +
          '                <li id="twidget-hotel-li"><a href="#twidget-tab2">' +
          _this.settings.localization.hotel_tab_caption +
          '</a></li>' +
          '            </ul>' +
          '        </nav>' +
          '        <!-- tabs -->' +
          ...
          (_this.settings.open_in_new_tab ? 'target="_blank"' : '') +
          '>' +
          '                    <a href="' +
          _this.settings.localization.avia_logo_link +
          '?marker=' +
          _this.settings.marker +
          '" class="twidget-logo">' +
          _this.settings.localization.avia_logo_content +
          '</a>' +
          '                    <a href="' +
          _this.settings.localization.avia_logo_link +
          '?marker=' +
          _this.settings.marker +
          '" class="twidget-title">' +
          _this.settings.localization.avia_logo_caption +
          '</a>' +
          '                </div>' +
          '                <div class="clearfix"></div>' +
          '                <form action="' +
          _this.settings.localization.avia_submit_domain +
          ...
          '                                <label for="twidget-origin">' +
          _this.settings.localization.avia_input_origin_label +
          '</label>' +
          '                                <input type="text" id="twidget-origin" placeholder="' +
          _this.settings.localization.avia_input_origin_label +
          '" required>' +
          ...
          (_this.settings.lock_destination ? 'twidget-input-locked' : '') +
          '">' +
          '                            <div class="twidget-input-box">' +
          '                                <label for="twidget-origin">' +
          _this.settings.localization.avia_input_destination_label +
          '</label>' +
          '                                <input type="text" ' +
          (_this.settings.lock_destination ? 'disabled' : '') +
          ' id="twidget-destination" placeholder="' +
          _this.settings.localization.avia_input_destination_label +
          '" required>' +
          ...
          '                                <div class="twidget-input-box">' +
          '                                    <label for="twidget-origin">' +
          _this.settings.localization.avia_input_date_start +
          '</label>' +
          '                                    <input type="text" name="depart_date" placeholder="' +
          _this.settings.localization.avia_input_date_start +
          '" required value="' +
          dateOneWeekLater.getFullYear() +
          '-' +
          (dateOneWeekLater.getMonth() + 1) +
          '-' +
          dateOneWeekLater.getDate() +
          '">' +
          ...
          '                                <div class="twidget-input-box">' +
          '                                    <label for="twidget-origin">' +
          _this.settings.localization.avia_input_date_end +
          '</label>' +
          '                                    <input type="text" name="return_date" placeholder="' +
          _this.settings.localization.avia_input_date_end +
          '" value="' +
          dateTwoWeekLater.getFullYear() +
          '-' +
          (dateTwoWeekLater.getMonth() + 1) +
          '-' +
          dateTwoWeekLater.getDate() +
          '">' +
          '                                    <div class="twidget-icon-cal""></div>' +
          ...
          '                            <label for="twidget-passengers-detail">' +
          _this.settings.localization.avia_passengers_select_caption +
          '</label>' +
          '                            <div class="twidget-passengers-detail">' +
          '                                <div class="twidget-pas-no"><span id="twidget-pas">1</span> <span class="twidget-pas-caption">' +
          _this.settings.localization.avia_passengers_caption_1 +
          '</span></div>' +
          '                                <div class="twidget-class">' +
          _this.settings.localization.avia_passengers_economy_class +
          '</div>' +
          '                            </div>' +
          ...
          '                                        <li>' +
          '                                            <div class="twidget-cell twidget-age-name">' +
          _this.settings.localization.avia_passengers_select_adults +
          '</div>' +
          '                                            <div class="twidget-cell twidget-age-select">' +
          ...
          '                                        <li>' +
          '                                            <div class="twidget-cell twidget-age-name">' +
          _this.settings.localization.avia_passengers_select_children +
          '</div>' +
          '                                            <div class="twidget-cell twidget-age-select">' +
          ...
          '                                        <li>' +
          '                                            <div class="twidget-cell twidget-age-name">' +
          _this.settings.localization.avia_passengers_select_infants +
          '</div>' +
          '                                            <div class="twidget-cell twidget-age-select">' +
          ...
          '                                            <label>' +
          _this.settings.localization.avia_passengers_business_class_checkbox +
          '</label>' +
          ...
          '                                            <div class="twidget-passengers-ready-button">' +
          _this.settings.localization.avia_passengers_select_ready_button +
          '</div>' +
          '                                        </li>' +
          '                                    </ul>' +
          '                                </div>' +
          ...
          '                            <button type="submit">' +
          _this.settings.localization.avia_submit_button_text +
          '</button>' +
          '                        </li>' +
          '                    </ul>' +
          '                </form>' +
          ...
          '>' +
          '                    <a href="' +
          _this.settings.localization.hotel_logo_link +
          '?marker=' +
          _this.settings.marker +
          '" class="twidget-logo"><div class="twidget-logo-image twidget-hotellook-logo-img" width="30" height="30"></div>hotellook</a>' +
          '                    <a href="' +
          _this.settings.localization.hotel_logo_link +
          '?marker=' +
          _this.settings.marker +
          '" class="twidget-title">' +
          _this.settings.localization.hotel_logo_caption +
          '</a>' +
          '                </div>' +
          '                <form action="https://search.hotellook.com/" method="get" autocomplete="off" ' +
          (_this.settings.open_in_new_tab ? 'target="_blank"' : '') +
          '>' +
          '                    <ul class="twidget-form-list clearfix">' +
          '                        <!-- hotel city input -->' +
          ...
          '                            <div class="twidget-input-box">' +
          '                                <label for="twidget-city-hotel">' +
          _this.settings.localization.hotel_input_destination_label +
          '</label>' +
          '                                <input type="text" id="twidget-city-hotel" placeholder="' +
          _this.settings.localization.hotel_input_destination_label +
          '" required>' +
          ...
          '                                <div class="twidget-input-box">' +
          '                                    <label for="checkIn">' +
          _this.settings.localization.hotel_input_date_start +
          '</label>' +
          '                                    <input type="text" name="checkIn" placeholder="' +
          _this.settings.localization.hotel_input_date_start +
          '" value="' +
          dateOneWeekLater.getFullYear() +
          '-' +
          ...
          '                                <div class="twidget-input-box">' +
          '                                    <label for="checkOut">' +
          _this.settings.localization.hotel_input_date_end +
          '</label>' +
          ...
          '                            <label for="twidget-guest-detail">' +
          _this.settings.localization.hotel_guests_select_caption +
          '</label>' +
          '                            <div class="twidget-guest-detail">' +
          '                                <div class="twidget-guest-no"><span id="twidget-g-no">1</span> <span class="twidget-guest-caption">' +
          _this.settings.localization.hotel_guests_caption_1 +
          '</span></div>' +
          '                            </div>' +
          ...
          '                                        <li>' +
          '                                            <div class="twidget-cell twidget-age-name">' +
          _this.settings.localization.hotel_guests_select_children +
          '</div>' +
          '                                            <div class="twidget-cell twidget-age-select">' +
          ...
          '                        <li class="twidget-submit-button">' +
          '                            <button type="submit">' +
          _this.settings.localization.hotel_submit_button_text +
          '</button>' +
          '                        </li>' +
          '                    </ul>' +
          '                </form>' +
