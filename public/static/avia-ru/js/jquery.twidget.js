    ...
    $.extend(Plugin.prototype, {
        init: function () {
            ...
            var origin_iata_input = container.find('input[name="origin_iata"]'),
                ...
                /* hotel vars */
                destination_hotel_input = container.find(
            ...
            container
                .find(".twidget-passengers-ready-button")
                .click(function () {
                    container
                        .find(".twidget-passengers-detail")
                        .trigger("click");
                });
            ...
            $(document).on(
                ...
                function () {
                    var button = $(this),
                        ...
                        children_pas_count = parseFloat(
                            children_pas_input.val()
                        ),
                    ...
                    if (button.text() == "+") {
                        ...
                        if (
                            button.attr("data-age") == "children-g" &&
                            newVal < 3
                        ) {
                            ...
                            container
                                .find(
                                    "#twidget-guest-form .twidget-pas-class ul"
                                )
                                .append(
                        ...
                        if (
                            button.attr("data-age") == "one-child" &&
                            newVal < 17
                        ) {
                        ...
                        if (input.val() > 0) {
                            ...
                            if (button.attr("data-age") == "children-g") {
                                ...
                                container
                                    .find(
                                        "#twidget-guest-form .twidget-pas-class li:last-child"
                                    )
                                    .remove();
                                if (newVal == 0) {
                                    container
                                        .find(
                                            "#twidget-guest-form .twidget-pas-class"
                                        )
                                        .hide();
                                }
                            }
            ...
            dateReturn.focus(function () {
                setTimeout(function () {
                    if (
                        ...
                        $(document)
                            .find(
                                ".datepicker tbody .datepicker-cancel-return-date"
                            )
                            .parent()
                            .remove();
                        $(document)
                        ...
                        if (data) {
                            container
                                ...
                                .on("focusout", function () {
                                    container
                                        .find("#twidget-origin")
                                        .val(data[0].city_name);
                                    container
                                        .find(".twidget-origin-iata")
                                        .text(data[0].code);
                                    container
                                        .find(
                                            ".twidget-origin .twidget-pseudo-name"
                                        )
                    ...
                    function (data) {
                        ...
                        $.each(data, function (key, value) {
                            if (value.city_name) {
                                ...
                                if (!value.name) {
                                    citiesSortedArr[value.city_code].main =
                                        value;
                                } else {
                                    citiesSortedArr[value.city_code].push(
                                        value
                                    );
                                }
                        ...
                        $.each(citiesOrigSort, function (key, value) {
                            if (citiesSortedArr[value].main) {
                                container
                                    .find(
                                        ".twidget-origin .twidget-auto-fill-wrapper ul"
                                    )
                                    .append(
                                        '<li class="clearfix">' +
                                            '<span class="twidget-city-name" data-name="' +
                                            citiesSortedArr[value].main
                                                .city_name +
                                            '" data-country="' +
                                            citiesSortedArr[value].main
                                                .country_name +
                            ...
                            container
                                ...
                                .on("focusout", function () {
                                    focus_timeout = setTimeout(function () {
                                        ...
                                        container
                                            .find(
                                                ".twidget-origin .twidget-auto-fill-wrapper"
                                            )
                                            .removeClass("active");
                                    }, 200);
                                });
                        ...
                        if (data) {
                            container
                                ...
                                .on("focusout", function () {
                                    ...
                                    container
                                        .find(
                                            ".twidget-destination .twidget-pseudo-name"
                                        )
                                        .text(data[0].city_name);
                                    container
                                        .find(
                        ...
                        function (data) {
                            ...
                            $.each(citiesOrigSort, function (key, value) {
                                if (citiesSortedArr[value].main) {
                                    container
                                        .find(
                                            ".twidget-destination .twidget-auto-fill-wrapper ul"
                                        )
                                        .append(
                                            '<li class="clearfix">' +
                                                '<span class="twidget-city-name" data-name="' +
                                ...
                                container
                                    ...
                                    .on("focusout", function () {
                                        focus_timeout = setTimeout(function () {
                                            ...
                                            container
                                                .find(
                                                    ".twidget-destination .twidget-auto-fill-wrapper"
                                                )
                                                .removeClass("active");
                                        }, 200);
                                    });
                ...
                $.getJSON(
                    ...
                    function (data) {
                        ...
                        if (data.results.locations[0]) {
                            focus_destination =
                                data.results.locations[0].cityName;
                            focus_country =
                                data.results.locations[0].countryName;
                        }
                        if (focus_destination) {
                            container
                                ...
                                .on("focusout", function () {
                                    container
                                        .find("#twidget-city-hotel")
                                        .val(focus_destination);
                                    destination_hotel_input.val(
                                        focus_destination
                                    );
                                    container
                                        .find(
                                            ".twidget-city-hotel .twidget-pseudo-name"
                                        )
                                    ...
                                    container
                                        .find(
                                            ".twidget-city-hotel .twidget-auto-fill-wrapper"
                                        )
                                        .removeClass("active");
                                });
                            container
                ...
                $.getJSON(
                    ...
                    function (data) {
                        ...
                        $.each(data.results.locations, function (key, value) {
                            container
                                .find(
                                    ".twidget-city-hotel .twidget-auto-fill-wrapper ul"
                                )
                                .append(
                                    '<li class="clearfix ' +
                                        (key == 0 ? "main-city" : "") +
                        ...
                        if (
                            !container.find("#twidget-city-hotel").is(":focus")
                        ) {
                            container
                                .find("#twidget-city-hotel")
                                .trigger("focusout");
            ...
            $(
                "#twidget-origin, #twidget-destination, #twidget-city-hotel"
            ).click(function () {
                $(this).select();
            });
        },
        widget_html: function () {
            ...
            $(this.element).html(
                "<!-- start widget-->" +
                    ...
                    (_this.settings.lock_destination
                        ? "twidget-input-locked"
                        : "") +
                    '">' +
                    '                            <div class="twidget-input-box">' +
                    '                                <label for="twidget-origin">' +
                    ...
                    '                                            <div class="twidget-cell twidget-age-name">' +
                    _this.settings.localization
                        .avia_passengers_select_children +
                    "</div>" +
                    '                                            <div class="twidget-cell twidget-age-select">' +
